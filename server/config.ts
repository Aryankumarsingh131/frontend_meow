...
export function readConfig(env: Record<string, string | undefined>) {
  ...
  const supabaseUrl = env.JALSAKSHI_SUPABASE_URL
  ...
  return { environment, dataMode, supabaseUrl: url.origin, publishableKey, sessionKey, secureCookie: environment === 'production' || env.AUTH_SECURE_COOKIE === 'true' }
}
