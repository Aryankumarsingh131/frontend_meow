...
export interface Source { id: string; team_id: string; name: string; locality: string; version: number }
...
export interface Screening { capture_name: string | null; id: string; source_id: string; sample_code: string; machine_suggestion: string; human_observation: string; screening_flag: string; captured_at: string; created_by: string }
...
export interface CaseAction { id: string; case_id: string; kind: 'referral' | 'corrective'; description: string; performed_by: string; performed_at: string; evidence_name: string | null }
...
export interface Complaint { id: string; source_id: string | null; case_id: string | null; summary: string; status: 'new' | 'linked'; received_at: string; version: number }
